...
![ICMP 目标不可达消息](./assets/ping的工作原理/3.jpg)
...
![ICMP 报文](./assets/ping的工作原理/4.jpg)
...
![常见的 ICMP 类型](./assets/ping的工作原理/5.jpg)
...
![目标不可达类型的常见代码号](./assets/ping的工作原理/8.jpg)
...
![MTU 路径发现（UDP的情况下）](./assets/ping的工作原理/17.jpg)
