...
![img](./assets/Mysql一行记录是怎么存储的/1.png)
...
![img](./assets/Mysql一行记录是怎么存储的/2.png)
...
![img](./assets/Mysql一行记录是怎么存储的/3.png)
...
![img](./assets/Mysql一行记录是怎么存储的/4.png)
...
![img](./assets/Mysql一行记录是怎么存储的/5.png)
...
![img](./assets/Mysql一行记录是怎么存储的/15.png)
...
![img](./assets/Mysql一行记录是怎么存储的/16.png)
...
![img](./assets/Mysql一行记录是怎么存储的/17.png)

可以看到，还是不行，接下来看看 varchar(65532) 是否可行？

![img](./assets/Mysql一行记录是怎么存储的/18.png)
...
![img](./assets/Mysql一行记录是怎么存储的/20.png)
...
![img](./assets/Mysql一行记录是怎么存储的/21.png)
