...
![img](./assets/已建立连接的TCP收到SYN会发生什么/1.jpg)
...
![img](./assets/已建立连接的TCP收到SYN会发生什么/2.png)
...
![img](./assets/已建立连接的TCP收到SYN会发生什么/3.png)
...
![img](./assets/已建立连接的TCP收到SYN会发生什么/4.png)
...
![img](./assets/已建立连接的TCP收到SYN会发生什么/5.png)
...
![img](./assets/已建立连接的TCP收到SYN会发生什么/6.png)
