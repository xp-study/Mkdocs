...
![IP 的作用与 MAC 的作用](./assets/IP基础知识全家桶/2.jpg)
...
![点分十进制](./assets/IP基础知识全家桶/3.jpg)

那么，IP 地址最大值也就是

![img](./assets/IP基础知识全家桶/4.jpg)

也就说，最大允许 43 亿台计算机连接到网络。

实际上，IP 地址并不是根据主机台数来配置的，而是以网卡。像服务器、路由器等设备都是有 2 个以上的网卡，也就是它们会有 2 个以上的 IP 地址。

![每块网卡可以分配一个以上的IP地址](./assets/IP基础知识全家桶/5.jpg)
...
![IP 地址分类](./assets/IP基础知识全家桶/6.jpg)
...
![img](./assets/IP基础知识全家桶/7.jpg)

> A、B、C 分类地址最大主机个数是如何计算的呢？

最大主机个数，就是要看主机号的位数，如 C 类地址的主机号占 8 位，那么 C 类地址的最大主机个数：

![img](./assets/IP基础知识全家桶/8.jpg)

为什么要减 2 呢？

因为在 IP 地址中，有两个 IP 是特殊的，分别是主机号全为 1 和 全为 0 地址。

![img](./assets/IP基础知识全家桶/9.jpg)
...
![本地广播与直接广播](./assets/IP基础知识全家桶/10.jpg)

> 什么是 D、E 类地址？

而 D 类和 E 类地址是没有主机号的，所以不可用于主机 IP，D 类常被用于 **多播** ，E 类是预留的分类，暂时未使用。

![img](./assets/IP基础知识全家桶/11.jpg)
...
![单播、广播、多播通信](./assets/IP基础知识全家桶/12.jpg)
...
![IP 分类判断](./assets/IP基础知识全家桶/13.jpg)
...
![img](./assets/IP基础知识全家桶/14.jpg)

还有另一种划分网络号与主机号形式，那就是 **子网掩码** ，掩码的意思就是掩盖掉主机号，剩余的就是网络号。

 **将子网掩码和 IP 地址按位计算 AND，就可得到网络号。**  

![img](./assets/IP基础知识全家桶/15.jpg)
...
![IP地址的网络号](./assets/IP基础知识全家桶/16.jpg)
...
![img](./assets/IP基础知识全家桶/18.jpg)

由于子网网络地址被划分成 2 位，那么子网地址就有 4 个，分别是 00、01、10、11，具体划分如下图：

![img](./assets/IP基础知识全家桶/19.jpg)

划分后的 4 个子网如下表格：

![img](./assets/IP基础知识全家桶/20.jpg)

### 公有 IP 地址与私有 IP 地址

在 A、B、C 分类地址，实际上有分公有 IP 地址和私有 IP 地址。

![img](./assets/IP基础知识全家桶/21.jpg)
...
![公有 IP 地址与私有 IP 地址](./assets/IP基础知识全家桶/22.jpg)
...
![IP 地址与路由控制](./assets/IP基础知识全家桶/24.jpg)
...
![IPv6 地址表示方法](./assets/IP基础知识全家桶/26.jpg)

如果出现连续的 0 时还可以将这些 0 省略，并用两个冒号 「::」隔开。但是，一个 IP 地址中只允许出现一次两个连续的冒号。

![Pv6 地址缺省表示方](./assets/IP基础知识全家桶/27.jpg)
...
![IPv6地址结构](./assets/IP基础知识全家桶/28.jpg)
...
![ IPv6 中的单播通信](./assets/IP基础知识全家桶/29.jpg)

### IPv4 首部与 IPv6 首部

IPv4 首部与 IPv6 首部的差异如下图：

![IPv4 首部与 IPv6 首部的差异](./assets/IP基础知识全家桶/30.jpg)
...
![DNS 树状结构](./assets/IP基础知识全家桶/31.jpg)
...
![域名解析的工作流程](./assets/IP基础知识全家桶/32.jpg)
...
![ARP 广播](./assets/IP基础知识全家桶/33.jpg)
...
![DHCP 工作流程](./assets/IP基础知识全家桶/35.jpg)
...
![ DHCP 中继代理](./assets/IP基础知识全家桶/36.jpg)
...
![ICMP 目标不可达消息](./assets/IP基础知识全家桶/39.jpg)
...
![常见的 ICMP 类型](./assets/IP基础知识全家桶/40.jpg)
...
![ IGMP 常规查询与响应工作机制](./assets/IP基础知识全家桶/42.jpg)
...
![ IGMPv2 离开组播组工作机制 情况1](./assets/IP基础知识全家桶/43.jpg)
...
![ IGMPv2 离开组播组工作机制 情况2](./assets/IP基础知识全家桶/44.jpg)
