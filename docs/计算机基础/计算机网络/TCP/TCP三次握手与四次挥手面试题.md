...
![img](./assets/TCP三次握手与四次挥手面试题/10.png)
...
![三次握手避免历史连接](./assets/TCP三次握手与四次挥手面试题/16.png)
...
![两次握手无法阻止历史连接](./assets/TCP三次握手与四次挥手面试题/17.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/21.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/25.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/26.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/27.png)
...
具体为什么是三个参数决定 TCP 半连接队列的大小，可以看这篇：可以看这篇：[TCP 半连接队列和全连接队列满了会发生什么？又该如何应对？](https://docs.wsh-study.com/%E8%AE%A1%E7%AE%97%E6%9C%BA%E5%9F%BA%E7%A1%80/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C/TCP/TCP%E5%8D%8A%E8%BF%9E%E6%8E%A5%E9%98%9F%E5%88%97%E5%92%8C%E5%85%A8%E8%BF%9E%E6%8E%A5%E9%98%9F%E5%88%97/)
...
![客户端主动关闭连接 —— TCP 四次挥手](./assets/TCP三次握手与四次挥手面试题/31.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/32.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/35.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/37.png)
...
![TCP 抓包图](./assets/TCP三次握手与四次挥手面试题/38.png)

通过前面我们知道， **序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据** 。

假设 TIME-WAIT 没有等待时间或时间过短，被延迟的数据包抵达后会发生什么呢？

![TIME-WAIT 时间过短，收到旧连接的数据报文](./assets/TCP三次握手与四次挥手面试题/39.png)
...
![HTTP 短连接](./assets/TCP三次握手与四次挥手面试题/42.png)
...
![img](./assets/TCP三次握手与四次挥手面试题/43.png)
...
![web 服务的 心跳机制](./assets/TCP三次握手与四次挥手面试题/46.png)
