...
![img](./assets/MySQL是怎么加锁的/22.png)

我们也可以通过 `select * from performance_schema.data_locks\G;` 这条语句来看看事务 A 加了什么锁。

输出结果如下，我这里只截取了行级锁的内容。

![img](./assets/MySQL是怎么加锁的/23.png)
...
![img](./assets/MySQL是怎么加锁的/28.png)

非唯一索引加锁的流程图：

![img](./assets/MySQL是怎么加锁的/29.png)
