...
![本文提纲](./assets/TCP半连接队列和全连接队列/1.jpg)
...
![半连接队列与全连接队列](./assets/TCP半连接队列和全连接队列/2.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/3.jpg)

在「LISTEN 状态」时，`Recv-Q/Send-Q` 表示的含义如下：

![img](./assets/TCP半连接队列和全连接队列/4.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/5.jpg)
...
![测试环境](./assets/TCP半连接队列和全连接队列/6.jpg)
...
![全连接队列溢出](./assets/TCP半连接队列和全连接队列/10.jpg)

> Linux 有个参数可以指定当 TCP 全连接队列满了会使用什么策略来回应客户端。

实际上，丢弃连接只是 Linux 的默认行为，我们还可以选择向客户端发送 RST 复位报文，告诉客户端连接已经建立失败。

![img](./assets/TCP半连接队列和全连接队列/11.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/12.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/20.jpg)
...
![测试环境](./assets/TCP半连接队列和全连接队列/21.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/22.jpg)

当服务端受到 SYN 攻击后，连接服务端 ssh 就会断开了，无法再连上。只能在服务端主机上执行查看当前 TCP 半连接队列大小：

![img](./assets/TCP半连接队列和全连接队列/23.jpg)

同时，还可以通过 netstat -s 观察半连接队列溢出的情况：

![img](./assets/TCP半连接队列和全连接队列/24.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/25.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/26.jpg)

从源码中，我可以得出共有三个条件因队列长度的关系而被丢弃的：

![img](./assets/TCP半连接队列和全连接队列/27.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/28.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/31.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/36.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/37.jpg)
...
![开启 syncookies 功能](./assets/TCP半连接队列和全连接队列/38.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/39.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/40.jpg)

增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：

![img](./assets/TCP半连接队列和全连接队列/41.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/42.jpg)
...
![img](./assets/TCP半连接队列和全连接队列/43.jpg)
