...
![img](./assets/HTTP1.1如何优化/4.png)

如果 **重定向的工作交由代理服务器完成，就能减少 HTTP 请求次数了** ，如下图：

![img](./assets/HTTP1.1如何优化/5.png)

而且当代理服务器知晓了重定向规则后，可以进一步减少消息传递次数，如下图：

![img](./assets/HTTP1.1如何优化/6.png)

除了 `302` 重定向响应码，还有其他一些重定向的响应码，你可以从下图看到：

![img](./assets/HTTP1.1如何优化/7.png)
...
![图来源于：墨染枫林的CSDN](./assets/HTTP1.1如何优化/8.png)
...
![图来源于：陈健平的CSDN ](./assets/HTTP1.1如何优化/9.png)
...
![来源于：https://isparta.github.io/compare-webp/index.html](./assets/HTTP1.1如何优化/10.png)
