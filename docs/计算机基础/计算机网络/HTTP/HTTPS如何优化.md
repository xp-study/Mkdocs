...
![img](./assets/HTTPS如何优化/3.jpg)

对于计算机里也是一样，软件都是跑在物理硬件上，硬件越牛逼，软件跑的也越快，所以如果要优化 HTTPS，最直接的方式就是花钱买性能参数更牛逼的硬件。
...
![img](./assets/HTTPS如何优化/14.png)

同样的，Pre-shared Key 也有重放攻击的危险。

![img](./assets/HTTPS如何优化/15.png)
