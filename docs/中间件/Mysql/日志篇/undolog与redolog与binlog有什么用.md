...
![img](./assets/undolog与redolog与binlog有什么用/2.png)
...
![回滚事务](./assets/undolog与redolog与binlog有什么用/3.png)
...
![版本链](./assets/undolog与redolog与binlog有什么用/4.png)
...
![Buffer Poo](./assets/undolog与redolog与binlog有什么用/5.png)
...
![img](./assets/undolog与redolog与binlog有什么用/6.png)
...
![img](./assets/undolog与redolog与binlog有什么用/7.png)
...
![事务恢复](./assets/undolog与redolog与binlog有什么用/8.png)
...
![事务恢复](./assets/undolog与redolog与binlog有什么用/9.png)
...
![img](./assets/undolog与redolog与binlog有什么用/10.png)
...
![img](./assets/undolog与redolog与binlog有什么用/11.png)
...
![重做日志文件组](./assets/undolog与redolog与binlog有什么用/12.png)
...
![重做日志文件组写入过程](./assets/undolog与redolog与binlog有什么用/13.png)
...
![img](./assets/undolog与redolog与binlog有什么用/14.png)
...
![MySQL 主从复制过程](./assets/undolog与redolog与binlog有什么用/15.png)
...
![MySQL 主从架构](./assets/undolog与redolog与binlog有什么用/16.png)
...
![binlog cach](./assets/undolog与redolog与binlog有什么用/17.png)
...
![两阶段提交](./assets/undolog与redolog与binlog有什么用/18.png)
...
![时刻 A 与时刻 B](./assets/undolog与redolog与binlog有什么用/19.png)
...
![每个阶段都有一个队列](./assets/undolog与redolog与binlog有什么用/20.png)
...
![img](./assets/undolog与redolog与binlog有什么用/21.png)

接着，获取队列中的事务组，由绿色事务组的 Leader 对 rodo log 做一次 write + fsync，即一次将同组事务的 redolog 刷盘：

![img](./assets/undolog与redolog与binlog有什么用/22.png)

完成了 prepare 阶段后，将绿色这一组事务执行过程中产生的 binlog 写入 binlog 文件（调用 write，不会调用 fsync，所以不会刷盘，binlog 缓存在操作系统的文件系统中）。

![img](./assets/undolog与redolog与binlog有什么用/23.png)
...
![img](./assets/undolog与redolog与binlog有什么用/26.png)
