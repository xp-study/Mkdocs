...
![图片](./assets/为什么MySQL采用B+树作为索引/1.png)
...
![图片](./assets/为什么MySQL采用B+树作为索引/2.png)
...
![请添加图片描述](./assets/为什么MySQL采用B+树作为索引/3.webp)
...
![请添加图片描述](./assets/为什么MySQL采用B+树作为索引/6.webp)
...
![图片](./assets/为什么MySQL采用B+树作为索引/7.webp)
...
![图片](./assets/为什么MySQL采用B+树作为索引/11.webp)

我们来看看一棵 3 阶的 B 树的查询过程是怎样的？

![图片](./assets/为什么MySQL采用B+树作为索引/12.webp)
...
![图片](./assets/为什么MySQL采用B+树作为索引/13.png)
...
![请添加图片描述](./assets/为什么MySQL采用B+树作为索引/14.webp)
...
![图片](./assets/为什么MySQL采用B+树作为索引/18.png)
