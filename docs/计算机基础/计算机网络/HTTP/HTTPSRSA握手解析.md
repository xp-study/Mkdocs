...
![img](./assets/HTTPSRSA握手解析/4.png)

对应 Wireshark 的抓包，我也画了一幅图，你可以从下图很清晰地看到该过程：

![img](./assets/HTTPSRSA握手解析/5.png)
...
![img](./assets/HTTPSRSA握手解析/8.png)

随后，服务端发了「 **Server Hello Done** 」消息，目的是告诉客户端，我已经把该给你的东西都给你了，本次打招呼完毕。

![img](./assets/HTTPSRSA握手解析/9.png)
...
![img](./assets/HTTPSRSA握手解析/10.png)
...
![img](./assets/HTTPSRSA握手解析/11.png)
...
![img](./assets/HTTPSRSA握手解析/12.png)

操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![img](./assets/HTTPSRSA握手解析/13.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![img](./assets/HTTPSRSA握手解析/14.png)
...
![img](./assets/HTTPSRSA握手解析/15.png)
...
![img](./assets/HTTPSRSA握手解析/16.png)
...
![img](./assets/HTTPSRSA握手解析/17.png)
