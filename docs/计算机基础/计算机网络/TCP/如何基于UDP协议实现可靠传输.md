...
![img](./assets/如何基于UDP协议实现可靠传输/1.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/2.png)

整体看的视角是这样的：

![img](./assets/如何基于UDP协议实现可靠传输/3.png)
...
![Packet Header](./assets/如何基于UDP协议实现可靠传输/4.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/5.png)

> 为什么要这么设计呢？

我们先来看看 TCP 的问题，TCP 在重传报文时的序列号和原始报文的序列号是一样的，也正是由于这个特性，引入了 TCP 重传的歧义问题。

![TCP 重传的歧义问题](./assets/如何基于UDP协议实现可靠传输/6.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/7.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/10.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/13.png)
...
![接收窗口](./assets/如何基于UDP协议实现可靠传输/14.jpg)
...
![HTTP/2](./assets/如何基于UDP协议实现可靠传输/15.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/16.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/17.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/18.png)

接着，接收方收到了发送方发送过来的数据，有的数据被上层读取了，有的数据丢包了，此时的接收窗口状况如下：

![img](./assets/如何基于UDP协议实现可靠传输/19.png)
...
![接收窗口触发的滑动](./assets/如何基于UDP协议实现可靠传输/20.png)
...
![Connection 流量控制](./assets/如何基于UDP协议实现可靠传输/26.png)
...
![img](./assets/如何基于UDP协议实现可靠传输/27.png)

## QUIC 是如何迁移连接的？

基于 TCP 传输协议的 HTTP 协议，由于是通过四元组（源 IP、源端口、目的 IP、目的端口）确定一条 TCP 连接。

![TCP 四元组](./assets/如何基于UDP协议实现可靠传输/28.png)
