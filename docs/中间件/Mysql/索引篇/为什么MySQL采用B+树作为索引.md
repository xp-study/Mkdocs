...
![请添加图片描述](./assets/为什么MySQL采用B+树作为索引/3.png)
...
![请添加图片描述](./assets/为什么MySQL采用B+树作为索引/6.png)
...
![图片](./assets/为什么MySQL采用B+树作为索引/7.png)
...
![图片](./assets/为什么MySQL采用B+树作为索引/8.png)
...
![图片](./assets/为什么MySQL采用B+树作为索引/11.png)

我们来看看一棵 3 阶的 B 树的查询过程是怎样的？

![图片](./assets/为什么MySQL采用B+树作为索引/12.png)
...
![请添加图片描述](./assets/为什么MySQL采用B+树作为索引/14.png)
