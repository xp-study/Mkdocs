...
![图片](./assets/count()和count(1)有什么区别/1.png)

## 哪种 count 性能最好？

我先直接说结论：

![图片](./assets/count()和count(1)有什么区别/2.png)
...
![图片](./assets/count()和count(1)有什么区别/3.png)

但是，如果表里有二级索引时，InnoDB 循环遍历的对象就不是聚簇索引，而是二级索引。

![图片](./assets/count()和count(1)有什么区别/4.png)
...
![图片](./assets/count()和count(1)有什么区别/5.png)
...
![图片](./assets/count()和count(1)有什么区别/6.png)
...
![图片](./assets/count()和count(1)有什么区别/7.png)
...
![图片](./assets/count()和count(1)有什么区别/8.png)
...
![图片](./assets/count()和count(1)有什么区别/9.png)
...
![图片](./assets/count()和count(1)有什么区别/10.png)
...
![图片](./assets/count()和count(1)有什么区别/11.png)

这时，我们就可以使用 show table status 或者 explain 命令来表进行估算。

执行 explain 命令效率是很高的，因为它并不会真正的去查询，下图中的 rows 字段值就是 explain 命令对表 t_order 记录的估算值。

![图片](./assets/count()和count(1)有什么区别/12.png)
