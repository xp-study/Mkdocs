...
![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/4.png)
...
![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/5.png)
...
![优雅关闭.drawio.png](./assets/TCP四次挥手可以变成三次吗/6.png)
...
![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/7.png)
...
![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/11.png)

先启用服务端：

![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/12.png)
...
![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/13.png)

此时，服务端的输出：

![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/14.png)

接下来，我们来看看抓包的结果。

![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/15.png)
...
![在这里插入图片描述](./assets/TCP四次挥手可以变成三次吗/16.png)
