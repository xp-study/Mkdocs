...
我在[上一篇文章 ](https://docs.wsh-study.com/%E4%B8%AD%E9%97%B4%E4%BB%B6/Mysql/%E4%BA%8B%E5%8A%A1%E7%AF%87/%E4%BA%8B%E5%8A%A1%E9%9A%94%E7%A6%BB%E7%BA%A7%E5%88%AB%E6%98%AF%E6%80%8E%E4%B9%88%E5%AE%9E%E7%8E%B0%E7%9A%84/)提到，MySQL InnoDB 引擎的默认隔离级别虽然是「可重复读」，但是它很大程度上避免幻读现象（并不是完全解决了），解决的方案有两种：
...
![img](./assets/MySQL可重复读隔离级别完全解决幻读了吗/1.png)

然后在可重复读隔离级别下，有两个事务的执行顺序如下：

![在这里插入图片描述](./assets/MySQL可重复读隔离级别完全解决幻读了吗/2.png)
...
![img](./assets/MySQL可重复读隔离级别完全解决幻读了吗/3.png)
...
![img](./assets/MySQL可重复读隔离级别完全解决幻读了吗/4.png)

举个具体例子，场景如下：

![img](./assets/MySQL可重复读隔离级别完全解决幻读了吗/5.png)
...
![img](./assets/MySQL可重复读隔离级别完全解决幻读了吗/6.png)
...
![img](./assets/MySQL可重复读隔离级别完全解决幻读了吗/7.png)
