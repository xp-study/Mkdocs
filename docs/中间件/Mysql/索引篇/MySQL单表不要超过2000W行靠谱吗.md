...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/1.png)

![图片](./assets/MySQL单表不要超过2000W行靠谱吗/2.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/3.png)

## **表空间**

下面我们再来看看索引的结构，我们下面讲内容都是基于 Innodb 引擎的，大家都知道 Innodb 的索引内部用的是 B+ 树。

![图片](./assets/MySQL单表不要超过2000W行靠谱吗/4.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/5.png)

## **页的数据结构**

实际页的内部结构像是下面这样的：

![图片](./assets/MySQL单表不要超过2000W行靠谱吗/6.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/7.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/8.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/9.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/10.png)
...
![图片](./assets/MySQL单表不要超过2000W行靠谱吗/11.png)
