...
![图片](./assets/TCP协议经典十五连问/4.png)

### 5. TIME-WAIT 状态为什么需要等待 2MSL

![图片](./assets/TCP协议经典十五连问/5.png)
...
![图片](./assets/TCP协议经典十五连问/8.png)快速重传流程
...
![图片](./assets/TCP协议经典十五连问/9.png)SACK机制
...
![图片](./assets/TCP协议经典十五连问/10.png)TCP的流量控制
...
![图片](./assets/TCP协议经典十五连问/16.png)三次握手
...
![图片](./assets/TCP协议经典十五连问/17.png)TCP的粘包和拆包
