...
![image.png](./assets/深入理解Linux虚拟内存管理/4.png)
...
![image.png](./assets/深入理解Linux虚拟内存管理/13.png)
...
![CPU读取内存.png](./assets/深入理解Linux虚拟内存管理/58.png)
...
![内存结构.png](./assets/深入理解Linux虚拟内存管理/59.png)

而每个存储器模块中包含了 8 个 DRAM 芯片，编号从 0 - 7 。

![存储器模块.png](./assets/深入理解Linux虚拟内存管理/60.png)
...
![DRAM芯片访问.png](./assets/深入理解Linux虚拟内存管理/61.png)
