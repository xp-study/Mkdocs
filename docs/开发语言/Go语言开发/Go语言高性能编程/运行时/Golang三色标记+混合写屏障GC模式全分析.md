...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/1.png)
图中表示是程序与对象的可达关系，目前程序的可达对象有对象1-2-3，对象4-7等五个对象。

**第二步**, 开始标记，程序找出它所有可达的对象，并做上标记。如下图所示：
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/2.png)
所以对象1-2-3、对象4-7等五个对象被做上标记。

**第三步**, 标记完了之后，然后开始清除未标记的对象. 结果如下。
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/3.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/11.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/17.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/18.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/19.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/20.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/21.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/22.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/23.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/24.png)

 但是如果栈不添加,当全部三色标记扫描之后,栈上有可能依然存在白色对象被引用的情况(如上图的对象9). 所以要对栈重新进行三色标记扫描, 但这次为了对象不丢失, 要对本次标记扫描启动STW暂停. 直到栈空间的三色标记结束.

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/25.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/26.png)

------

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/27.png)

------

 最后将栈和堆空间 扫描剩余的全部 白色节点清除. 这次STW大约的时间在10~100ms间.

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/28.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/29.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/30.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/31.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/33.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/34.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/35.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/36.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/37.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/38.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/39.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/40.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/41.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/42.png)
...
![img](./assets/Golang三色标记+混合写屏障GC模式全分析/43.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/44.png)

![img](./assets/Golang三色标记+混合写屏障GC模式全分析/45.png)
