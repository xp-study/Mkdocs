...
![图片](./assets/30张图解HTTP常见的面试题/1.png)提纲
...
![图片](./assets/30张图解HTTP常见的面试题/2.png)三个部分
...
![图片](./assets/30张图解HTTP常见的面试题/3.png)三方协议和租房协议
...
![图片](./assets/30张图解HTTP常见的面试题/6.png)五大类 HTTP 状态码
...
![图片](./assets/30张图解HTTP常见的面试题/7.png)
...
![图片](./assets/30张图解HTTP常见的面试题/8.png)
...
![图片](./assets/30张图解HTTP常见的面试题/9.png)
...
![图片](./assets/30张图解HTTP常见的面试题/10.png)
...
![图片](./assets/30张图解HTTP常见的面试题/11.png)
...
![图片](./assets/30张图解HTTP常见的面试题/12.png)GET 请求

而`POST` 方法则是相反操作，它向 `URI` 指定的资源提交数据，数据就放在报文的 body 里。

比如，你在我文章底部，敲入了留言后点击「提交」（ **暗示你们留言** ），浏览器就会执行一次 POST 请求，把你的留言文字放进了报文 body 里，然后拼接好 POST 请求头，通过 TCP 协议发送给服务器。

![图片](./assets/30张图解HTTP常见的面试题/13.png)POST 请求
...
![图片](./assets/30张图解HTTP常见的面试题/14.png)Cookie 技术
...
![图片](./assets/30张图解HTTP常见的面试题/15.png)
...
![图片](./assets/30张图解HTTP常见的面试题/16.png)短连接与长连接
...
![图片](./assets/30张图解HTTP常见的面试题/17.png)管道网络传输
...
![图片](./assets/30张图解HTTP常见的面试题/18.png)队头阻塞
...
![图片](./assets/30张图解HTTP常见的面试题/19.png)
...
![图片](./assets/30张图解HTTP常见的面试题/20.png)混合加密
...
![图片](./assets/30张图解HTTP常见的面试题/21.png)校验完整性
...
![图片](./assets/30张图解HTTP常见的面试题/22.png)数字证书工作流程
...
![图片](./assets/30张图解HTTP常见的面试题/23.png)HTTPS 连接建立过程
...
![图片](./assets/30张图解HTTP常见的面试题/24.png)报文区别
...
![图片](./assets/30张图解HTTP常见的面试题/25.png)HTT/1 ~ HTTP/2
...
![图片](./assets/30张图解HTTP常见的面试题/26.png)多路复用
...
![图片](./assets/30张图解HTTP常见的面试题/27.png)HTTP/1 ~ HTTP/3
...
![图片](./assets/30张图解HTTP常见的面试题/28.png)TCP HTTPS（TLS/1.3) 和 QUIC HTTPS
