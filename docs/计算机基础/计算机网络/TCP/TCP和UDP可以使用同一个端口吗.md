...
![img](./assets/TCP和UDP可以使用同一个端口吗/1.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/2.png)

UDP 网络编程如下，服务端是没有监听这个动作的，只有执行 bind() 系统调用来绑定端口的动作。

![img](./assets/TCP和UDP可以使用同一个端口吗/3.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/4.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/5.png)

运行这两个程序后，通过 netstat 命令可以看到，TCP 和 UDP 是可以同时绑定同一个端口号的。

![img](./assets/TCP和UDP可以使用同一个端口吗/6.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/10.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/11.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/12.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/13.png)
...
![img](./assets/TCP和UDP可以使用同一个端口吗/14.jpg)
