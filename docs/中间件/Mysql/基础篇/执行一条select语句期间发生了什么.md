...
![查询语句执行流程](./assets/执行一条select语句期间发生了什么/1.png)
...
![img](./assets/执行一条select语句期间发生了什么/2.png)

如果 MySQL 服务正常运行，完成 TCP 连接的建立后，连接器就要开始验证你的用户名和密码，如果用户名或密码不对，就收到一个"Access denied for user"的错误，然后客户端程序结束执行。

![img](./assets/执行一条select语句期间发生了什么/3.png)
...
![img](./assets/执行一条select语句期间发生了什么/4.png)
...
![img](./assets/执行一条select语句期间发生了什么/5.png)
...
![img](./assets/执行一条select语句期间发生了什么/6.png)
...
![img](./assets/执行一条select语句期间发生了什么/10.png)
...
![img](./assets/执行一条select语句期间发生了什么/11.png)
...
![img](./assets/执行一条select语句期间发生了什么/12.png)
...
![查询语句执行流程](./assets/执行一条select语句期间发生了什么/13.png)
