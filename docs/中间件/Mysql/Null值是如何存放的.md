...
![图片](./assets/MySql的Null值是如何存放的/1.png)
...
![图片](./assets/MySql的Null值是如何存放的/2.png)
...
![图片](./assets/MySql的Null值是如何存放的/3.png)
...
![图片](./assets/MySql的Null值是如何存放的/4.png)
...
![图片](./assets/MySql的Null值是如何存放的/14.png)
...
![图片](./assets/MySql的Null值是如何存放的/15.png)
...
![图片](./assets/MySql的Null值是如何存放的/16.png)

可以看到，还是不行，接下来看看 varchar(65532)  是否可行？

![图片](./assets/MySql的Null值是如何存放的/17.png)
...
![图片](./assets/MySql的Null值是如何存放的/18.png)
...
![图片](./assets/MySql的Null值是如何存放的/19.png)
